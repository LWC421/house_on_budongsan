    ...
    <table>
      ...
      <tbody>
        ...
        >
          <tr
            class="list-item"
            @click="goDetail(article.boardCode, article.memberCode)"
          >
...
import { getPageArticle, getCount } from '@/api/board'
